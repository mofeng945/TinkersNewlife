...
public class ClientEventHandler {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            // ✅ 融锻炉 GUI（对照匠魂熔炉）
            MenuScreens.register(ModMenus.MOLTEN_FORGE_MENU.get(),
                    com.mofengbaizhi.tinkersnewlife.client.screen.MoltenForgeScreen::new);
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        // 咒力外放 顺转能量弹：纯粒子视觉，占位渲染器
        event.registerEntityRenderer(ModEntities.CURSE_BOLT.get(),
                com.mofengbaizhi.tinkersnewlife.client.renderer.CurseBoltRenderer::new);
