...
public class Modifiers {
    ...
    /** 铁魔法联动特性·魔导（材料「圣灵」自带，有等级）：强化物品内刻印法术的强度 + 施法增伤 */
    public static final StaticModifier<com.mofengbaizhi.tinkersnewlife.content.modifier.ArcaneConductionModifier> ARCANE_CONDUCTION =
