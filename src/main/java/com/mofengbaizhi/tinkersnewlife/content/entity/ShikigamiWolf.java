...
/** 玉犬：继承原版狼，渲染/动画/纹理/碰撞箱全复用原版 */
public class ShikigamiWolf extends Wolf implements ShikigamiMob {

    private final ShikigamiState state = new ShikigamiState();

    public ShikigamiWolf(EntityType<? extends Wolf> type, Level level) {
        super(type, level);
    }
