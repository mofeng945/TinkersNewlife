...
/** 贯牛：继承原版net.minecraft.world.entity.animal.Cow，渲染/动画/纹理/碰撞箱全复用原版 */
public class ShikigamiCow extends net.minecraft.world.entity.animal.Cow implements ShikigamiMob {

    private final ShikigamiState state = new ShikigamiState();

    public ShikigamiCow(EntityType<? extends net.minecraft.world.entity.animal.Cow> type, Level level) {
        super(type, level);
    }

    public static AttributeSupplier.Builder createAttributes() {
        return net.minecraft.world.entity.animal.Cow.createAttributes()
