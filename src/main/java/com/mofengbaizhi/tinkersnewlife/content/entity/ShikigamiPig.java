...
/** 川豚：继承原版net.minecraft.world.entity.animal.Pig，渲染/动画/纹理/碰撞箱全复用原版 */
public class ShikigamiPig extends net.minecraft.world.entity.animal.Pig implements ShikigamiMob {

    private final ShikigamiState state = new ShikigamiState();

    public ShikigamiPig(EntityType<? extends net.minecraft.world.entity.animal.Pig> type, Level level) {
        super(type, level);
    }

    public static AttributeSupplier.Builder createAttributes() {
        return net.minecraft.world.entity.animal.Pig.createAttributes()
