...
/** 蛤蟆：继承原版net.minecraft.world.entity.animal.frog.Frog，渲染/动画/纹理/碰撞箱全复用原版 */
public class ShikigamiFrog extends net.minecraft.world.entity.animal.frog.Frog implements ShikigamiMob {

    private final ShikigamiState state = new ShikigamiState();

    public ShikigamiFrog(EntityType<? extends net.minecraft.world.entity.animal.frog.Frog> type, Level level) {
        super(type, level);
    }

    public static AttributeSupplier.Builder createAttributes() {
        return net.minecraft.world.entity.animal.frog.Frog.createAttributes()
