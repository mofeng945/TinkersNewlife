...
/** 脱兔：继承原版net.minecraft.world.entity.animal.Rabbit，渲染/动画/纹理/碰撞箱全复用原版 */
public class ShikigamiRabbit extends net.minecraft.world.entity.animal.Rabbit implements ShikigamiMob {

    private final ShikigamiState state = new ShikigamiState();

    public ShikigamiRabbit(EntityType<? extends net.minecraft.world.entity.animal.Rabbit> type, Level level) {
        super(type, level);
    }

    public static AttributeSupplier.Builder createAttributes() {
        return net.minecraft.world.entity.animal.Rabbit.createAttributes()
    ...
    public net.minecraft.world.entity.EntityDimensions getDimensions(Pose pose) {
        ...
        return net.minecraft.world.entity.EntityDimensions.fixed(0.4F * s, 0.5F * s);
    }
